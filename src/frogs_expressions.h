...
template<typename A, typename B, \
         template<class...> class Exp0, \
         typename T> \
constexpr Name##VV<Exp0<A,B>,Const<T>> Func(Exp0<A,B> a, T b) \
{ return {a, Const{b}}; } \
template<typename A, typename B, \
         template<class...> class Exp0, \
         typename T> \
constexpr Name##VV<Const<T>,Exp0<A,B>> Func(T a, Exp0<A,B> b) \
{ return {Const{a}, b}; } \
template<typename T0, typename T1> \
constexpr Name##VP<Const<T0>,Var<T1>> Func(T0 a, Var<T1>& b) \
{ return {Const{a}, &b}; } \
template<typename T0, typename T1> \
constexpr Name##PV<Var<T0>,Const<T1>> Func(Var<T0>& a, T1 b) \
{ return {&a, Const{b}}; } \
